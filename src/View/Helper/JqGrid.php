...
use Lemo\Grid\Column\ColumnAttributes;
...
class JqGrid extends AbstractHelper
{
    ...
    public function render(): string
    {
        ...
        if (!$grid instanceof GridInterface) {
            throw new Exception\UnexpectedValueException(sprintf(
                'Expected instance of Lemo\Grid\GridInterface; received "%s"',
                get_class($grid)
            ));
        }
        ...
        if (empty($filters['rules']) || empty($filters['operator'])) {
            foreach ($grid->getColumns() as $column) {
                ...
                if (isset($searchOptions['defaultValue'])) {
                    ...
                    /** @var \Lemo\Grid\Column\AbstractColumn $column */
     ...
     * @return string
     */
    public function renderScriptAutoresize(): string
    {
        $grid = $this->getGrid();
     ...
     * @return string
     */
    protected function buildScript($type, AbstractOptions $attributes): string
    {
        $script = [];
     ...
     */
    protected function gridModifyAttributes(JqGridPlatformOptions $attributes): JqGridPlatformOptions
    {
        // Pager element ID
     ...
     * @return string
     */
    protected function buildUrl(JqGridPlatformOptions $attributes): string
    {
        // URL
     ...
     * @return string
     */
    protected function buildStyle($style): string
    {
